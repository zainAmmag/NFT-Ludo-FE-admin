...
class EditCollection extends React.Component {
    ...
    submit = (data) => {
       ...
       if(validationcount>0)  return
        ...
        bodyFormData.append("Url", this.state.ExternalLink==null||this.state.ExternalLink.length<1||this.state.ExternalLink=="null"?"":this.state.ExternalLink);
        bodyFormData.append("Description", this.state.Description==null||this.state.Description.length<1||this.state.Description=="null"?"":this.state.Description);
        bodyFormData.append("WebsiteLink", this.state.WebsiteLink==null||this.state.WebsiteLink.length<1?"":this.state.WebsiteLink);
        bodyFormData.append("DiscordLink", this.state.DiscordLink==null||this.state.DiscordLink.length<1?"":this.state.DiscordLink);
        bodyFormData.append("TwitterLink", this.state.TwitterLink==null||this.state.TwitterLink.length<1?"":this.state.TwitterLink);
        bodyFormData.append("InstagramLink", this.state.InstagramLink==null||this.state.InstagramLink.length<1?"":this.state.InstagramLink);
        bodyFormData.append("MediumLink", this.state.MediumLink==null||this.state.MediumLink.length<1?"":this.state.MediumLink);
        bodyFormData.append("TLink", this.state.TLink==null||this.state.TLink.length<1?"":this.state.TLink);
